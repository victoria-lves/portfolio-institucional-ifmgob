...
<head>
    ...
    <style>
        ...
        .content-card {
            background: white; border-radius: 10px; box-shadow: 0 5px 15px rgba(0,0,0,0.05);
            padding: 25px; margin-bottom: 25px;
        }
        .label-detalhe { font-size: 0.85rem; color: #6c757d; text-transform: uppercase; font-weight: 700; display: block; margin-bottom: 5px; }
        .texto-detalhe { font-size: 1.05rem; margin-bottom: 20px; color: #212529; }
        .img-galeria { width: 100%; height: 200px; object-fit: cover; border-radius: 8px; cursor: pointer; transition: 0.3s; }
        .img-galeria:hover { opacity: 0.9; transform: scale(1.02); }
        .badge-area { background-color: #e9ecef; color: #495057; font-weight: 500; font-size: 0.9rem; padding: 8px 15px; border-radius: 50px; }
    </style>
</head>
<body>
            ...
            <div class="col-lg-8">
                <div class="content-card">
                    <div class="d-flex justify-content-between align-items-start mb-4">
                        <div>
                            <span class="badge bg-<?php echo $status_class; ?> mb-2"><?php echo htmlspecialchars($projeto['status']); ?></span>
                            <h2 class="h4 text-primary fw-bold"><?php echo htmlspecialchars($projeto['titulo']); ?></h2>
                            <span class="badge-area mt-2 d-inline-block">
                                <i class="bi bi-bookmark me-1"></i> <?php echo htmlspecialchars($projeto['area_conhecimento']); ?>
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="row g-3">
                        <?php foreach ($imagens as $img): ?>
                            <div class="col-md-4 col-6">
                                <a href="../../img/projetos/<?php echo htmlspecialchars($img['caminho']); ?>" target="_blank">
                                    <img src="../../img/projetos/<?php echo htmlspecialchars($img['caminho']); ?>" class="img-galeria">
                                </a>
                            </div>
                        <?php endforeach; ?>
                    </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="content-card bg-light border-primary border">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <form action="delete.php" method="POST" onsubmit="return confirm('Tem certeza que deseja excluir este projeto permanentemente?');">
                ...
                <div class="content-card">
                        ...
                        <?php if(!empty($autores)): ?>
                            <ul class="list-unstyled mb-0">
                                <?php foreach($autores as $autor): ?>
                                    <li class="mb-1"><i class="bi bi-person-check me-2"></i> <?php echo htmlspecialchars($autor['nome']); ?></li>
                                <?php endforeach; ?>
                            </ul>
                        <?php else: ?>
                    ...
                    <div class="mb-3">
                        ...
                        <p class="mb-0">
                            Início: <strong><?php echo date('d/m/Y', strtotime($projeto['data_inicio'])); ?></strong><br>
